...
<html lang="en">
  <head>
    ...
    <title>Puskesmas Purawasari</title>
    <link
  ...
  <section
      ...
      >
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo">
            ...
            <a href="logout.php" class="btn btn-fill text-white bg-success">LOGOUT</a>
          </div>
        </nav>
        <div class="hr">
          <hr
    ...
    <section>
      <div class="container">
        <h1 class="text-center">Database Puskesmas Purwasari</h1></br>
        <table class="table">
<thead class="text-center">
<tr>
<th>Database Obat</th>
<th>Database Dokter</th>
<th>Database Pasien</th>
<th>Database Periksa Pasien</th>
<th>Database Resep</th>
</tr>
</thead>
<tbody>
<tr>
<td><a class="btn btn-block btn-success" href="indexobat.php">Pilih</a></td>
<td><a class="btn btn-block btn-success" href="indexdokter.php">Pilih</a></td>
<td><a class="btn btn-block btn-success" href="indexpasien.php">Pilih</a></td>
<td><a class="btn btn-block btn-success" href="indexperiksa_pasien.php">Pilih</a></td>
<td><a class="btn btn-block btn-success" href="indexresep.php">Pilih</a></td>
</tr>
</tbody>
</div>
 </div>
